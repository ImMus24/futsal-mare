...
<body class="bg-[#0B131F] font-sans antialiased text-slate-200 flex min-h-screen items-center justify-center p-4 relative overflow-hidden">
    ...
    <main class="w-full max-w-md relative z-10 space-y-6">
        ...
        <div class="bg-[#152238]/80 backdrop-blur-xl p-8 rounded-3xl border border-slate-800/80 shadow-2xl relative overflow-hidden space-y-6">
            ...
            <!-- TOMBOL GOOGLE LOGIN -->
            <div>
                <a href="{{ route('admin.google.redirect') }}" class="w-full flex items-center justify-center gap-3 py-3 px-4 bg-[#0B131F] hover:bg-[#1a293e] border border-slate-700/80 hover:border-slate-500 text-slate-200 font-bold text-xs rounded-xl uppercase tracking-wider transition-all duration-200 shadow-md group">
            ...
            <div class="relative flex items-center justify-center">
                ...
                <span class="bg-[#152238] px-3 f-mono text-[10px] font-bold text-slate-500 uppercase tracking-widest absolute">Atau Email</span>
            </div>
